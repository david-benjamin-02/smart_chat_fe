...
export default function ChatApp() {
  ...
  const uidw = localStorage.setItem('uid', '98c6f287-c6ce-47d0-9183-ff279f07c773');
                ...
                <div className="d-flex align-items-end w-100">
                  ...
                  <AudioRecorder
                    onSendAudio={(audioURL) => {
                      ...
                      setMessages(prev => ({ ...prev, [selectedContact?.uid]: updated }));
                    ...
                    disabled={isVoiceChatRecording || isTranslating || !!selectedAttachment || input.trim()}
                  />
